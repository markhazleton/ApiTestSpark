...
function Update-SpecificAgent {
    ...
    switch ($Type) {
        ...
        'copilot'  { Update-AgentFile -TargetFile $COPILOT_FILE  -AgentName 'AI Coding Assistant' }
...
function Update-AllExistingAgents {
    ...
    if (Test-Path $COPILOT_FILE)  { if (-not (Update-AgentFile -TargetFile $COPILOT_FILE  -AgentName 'AI Coding Assistant')) { $ok = $false }; $found = $true }
