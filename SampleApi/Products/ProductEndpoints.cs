...
public static class ProductEndpoints
{
    ...
    private static Results<Ok<Product>, NotFound> GetById(
        [Description("The unique integer ID of the product. Seeded IDs: 1–10.")] int id,
    ...
    private static Ok<IReadOnlyList<Product>> GetByCategory(
        [Description("Category name to filter by (case-insensitive). Seeded values: Electronics, Office, Tools.")] string category,
        [FromServices] ProductCache cache) =>
    ...
    private static Results<Ok<Product>, ProblemHttpResult, NotFound> Update(
        [Description("The unique integer ID of the product to update. Seeded IDs: 1–10.")] int id,
        Product? product, [FromServices] ProductCache cache)
    {
        if (product is null) return TypedResults.Problem("Product body is required.", statusCode: 400);
    ...
    private static Results<NoContent, NotFound> Delete(
        [Description("The unique integer ID of the product to delete. Seeded IDs: 1–10.")] int id,
        [FromServices] ProductCache cache) =>
