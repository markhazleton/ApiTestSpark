...
// -----------------------------------------------------------------------
// Promotion / demonstration home page
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// Products API — the live demo endpoints discovered by API Test Spark
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// API Test Spark — serves at /api-test-spark/
// -----------------------------------------------------------------------
app.MapApiTestSpark(options =>
{
    options.OpenApiUrl = "/openapi/v1.json";
    options.AuthScheme = null;
});
