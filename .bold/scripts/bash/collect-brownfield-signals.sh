...
printf '{"config_files_present":%s,"dependency_manifests_present":%s,"ci_workflows":%s,"has_contributing":%s,"has_pr_template":%s,"recent_commit_messages":%s,"user":"%s"}\n' \
