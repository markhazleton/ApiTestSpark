...
printf '{"has_devspark":%s,"has_documentation_dir":%s,"has_bold_docs":%s,"total_files":%s,"non_hidden_files":%s,"user":"%s"}\n' \
  "$has_devspark" "$has_documentation_dir" "$has_bold_docs" "$total_files" "$non_hidden_files" "$(json_escape "$user_slug")"
