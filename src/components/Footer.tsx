  ...
  return (
    <footer className="mt-auto border-t border-gray-200 bg-gray-50 px-4 py-3 text-center text-xs text-gray-600">
      <div className="flex items-center justify-center gap-4 flex-wrap">
        ...
        <a href="https://apitest.makeboldspark.com" className="text-blue-600 hover:text-blue-800 hover:underline">
          API Test Spark
        </a>
        <span className="text-gray-400">|</span>
        <span>
          Built by{' '}
          <a href="https://markhazleton.com" className="text-blue-600 hover:text-blue-800 hover:underline">
            Mark Hazleton
          </a>
        </span>
        <span className="text-gray-400">·</span>
        <a href="https://makeboldsolutions.com" className="text-blue-600 hover:text-blue-800 hover:underline">
          Make Bold Solutions
        </a>
        {buildInfo && (
          <>
